            ...
            <div class="card" style="margin-bottom: 0px !important;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" name="email" id="email" class="form-control" value="" oninput="sugerirDominio(this)">

                                <div id="sugestoes-dominio" style="display: none;">
                                    <p>Sugestões de domínio:</p>
                                    <ul>
                                        <li><a href="#" onclick="selecionarDominio('gmail.com')">gmail.com</a></li>
                                        <li><a href="#" onclick="selecionarDominio('hotmail.com')">hotmail.com</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" name="cpf" class="form-control" value="" oninput="mascaraCPF(this)" maxlength="14">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" name="rg" id="rg" class="form-control" value="" oninput="formatarRG(this)">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sexo" id="sexo-masculino" value="Masculino" required>
                                    <label style="padding-left: 0px" class="form-check-label" for="sexo-masculino">Masculino</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="sexo" id="sexo-feminino" value="Feminino" required>
                                    <label  style="padding-left: 0px" class="form-check-label" for="sexo-feminino">Feminino</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" name="telefone_principal" id="telefone_principal" class="form-control" value="" maxlength="11" oninput="formatarTelefone(this)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" name="telefone_secundario" id="telefone_secundario" class="form-control" value="" maxlength="11" oninput="formatarTelefone(this)">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card" style="margin-bottom: 0px !important;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="estado_civil" id="sexo-masculino" value="Casado" required>
                                <label style="padding-left: 0px" class="form-check-label" for="sexo-masculino">Casado(a)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="estado_civil" id="sexo-feminino" value="Noivo" required>
                                <label  style="padding-left: 0px" class="form-check-label" for="sexo-feminino">Noivo(a)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="estado_civil" id="sexo-feminino" value="Solteiro" required>
                                <label  style="padding-left: 0px" class="form-check-label" for="sexo-feminino">Solteiro(a)</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="conjuge_membro_ibb" id="sexo-masculino" value="sim" required>
                                <label style="padding-left: 0px" class="form-check-label" for="sexo-masculino">Sim</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="conjuge_membro_ibb" id="sexo-masculino" value="nao" required>
                                <label style="padding-left: 0px" class="form-check-label" for="sexo-masculino">Não</label>
                            </div>
